    ...
    <div className=' flex  justify-center items-center '>
      ...
      <form className="container mx-auto w-[90%] my-1 ">
        <div action="" className='grid grid-cols-6   h-max  md:px-9  gap-7 items-start'>
          <div className=' col-span-6 md:col-span-3  h-max    '>
        ...
        <div className='flex flex-col md:flex-row justify-center md:justify-around w-full my-[10px] md:w-2/4 gap-5 items-center py-2 md:mx-5'>
